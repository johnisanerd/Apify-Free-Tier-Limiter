...
INTEGRATIONS = {
    ...
    "1SOrTCb3mzaT2TXHK": {
        ...
        "installed_utc": "2026-09-08",
        "charge_event": "ad_listed",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "requirements.txt",
        "notes": "REQS-REGEN. Shape A, 3 events (actor_start + ad_listed in main; ad_detail_pulled in module-level _run_ad_details, guard threaded in). try/finally added around the work.",
    },
    "XxBk71vGaUhUdlh5t": {
        "github_repo": "johnisanerd/ApifyFlightsDeals",
        "local_path": "~/Github/ApifyFlightsDeals/ApifyFlightsDeals",
        "installed_utc": "2026-09-08",
        "charge_event": "deal_returned",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "requirements.txt",
        "notes": "REQS-REGEN. Shape A, actor_start + deal_returned. guard.start before existing main try/finally; close added there.",
    },
    "gu4rpZbUIWaCEHfDk": {
        "github_repo": "johnisanerd/ApifyImmersiveProduct",
        "local_path": "~/Github/ApifyImmersiveProduct/ApifyImmersiveProduct",
        "installed_utc": "2026-09-08",
        "charge_event": "immersive_product_pulled",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "requirements.txt",
        "notes": "REQS-REGEN. Shape A, product_search (per query) + immersive_product_pulled (per row). try/finally added.",
    },
    "6wZ5v46uCs2aZBbOb": {
    ...
    "zciPdisDazYbEM6oe": {
        "github_repo": "johnisanerd/ApifyMapsReviewerGeoProfile",
        "local_path": "~/Github/ApifyMapsReviewerGeoProfile/ApifyMapsReviewerGeoProfile",
        "installed_utc": "2026-09-08",
        "charge_event": "contributor_analyzed",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "requirements.txt",
        "notes": "REQS-REGEN. Shape A, actor_start + contributor_analyzed. try/finally added.",
    },
    "P4gbxfqolqaL1FzKr": {
        "github_repo": "johnisanerd/ApifyGoogleTravelExplore",
        "local_path": "~/Github/ApifyGoogleTravelExplore/ApifyGoogleTravelExplore",
        "installed_utc": "2026-09-08",
        "charge_event": "destination_returned",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "requirements.txt",
        "notes": "REQS-REGEN. Shape A, actor_start + destination_returned. try/finally added.",
    },
    "mR53JWL9AQavhMjpm": {
        "github_repo": "johnisanerd/ApifyWellfoundJobs",
        "local_path": "~/Github/ApifyWellfoundJobs/ApifyWellfoundJobs",
        "installed_utc": "2026-09-08",
        "charge_event": "job-listing",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "requirements.txt",
        "notes": "REQS-REGEN. Shape A, 3 chained events (job-listing/description/detail) with limit_reached. Deeply nested loops, no try/finally: guard.close placed before the summary (no early return after guard.start; per-charge background flush persists metering).",
    },
    "aQh5hsmxuT39Qvp09": {
        "github_repo": "johnisanerd/ApifyZooplaProperty",
        "local_path": "~/Github/ApifyZooplaProperty/ApifyZooplaProperty",
        "installed_utc": "2026-09-08",
        "charge_event": "listing-scraped",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Shape A, two identical sites (search + url modes), main-wrapper. GOTCHA: first rebuild ran before the push landed (HTTP/2 disconnect) -> rebuilt again after push so the image has the guard.",
    },
    "QTzCLm6kNPnQTuCkO": {
        "github_repo": "johnisanerd/ApifyOracleJobs",
        "local_path": "~/Github/ApifyOracleJobs/ApifyOracleJobs",
        "installed_utc": "2026-09-08",
        "charge_event": "job_returned",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "uv.lock",
        "notes": "HYBRID: jobs bill via push_data(fresh, EVENT_JOB) meter-on-push -> guard.record(EVENT_JOB, billed) inside deliver_jobs; sites via guard.charge(EVENT_SITE). Main-wrapper.",
    },
    "Nf74KPJJhOveFtOwE": {
        "github_repo": "johnisanerd/ApifyOwlerCompanies",
        "local_path": "~/Github/ApifyOwlerCompanies/ApifyOwlerCompanies",
        "installed_utc": "2026-09-08",
        "charge_event": "company-scraped",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Shape A, chunked collect, main-wrapper.",
    },
    "q0YcgMZAM4HWibm9x": {
        "github_repo": "johnisanerd/ApifyPitchbookCompanies",
        "local_path": "~/Github/ApifyPitchbookCompanies/ApifyPitchbookCompanies",
        "installed_utc": "2026-09-08",
        "charge_event": "company-scraped",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Shape A, chunked collect, inline (single-main).",
    },
    "dB44opp3KJj8asVb9": {
        "github_repo": "johnisanerd/ApifyRapidAPI",
        "local_path": "~/Github/ApifyRapidAPI/ApifyRapidAPI",
        "installed_utc": "2026-09-08",
        "charge_event": "api_listing",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Shape A, events api_listing + api_detail (mode-dependent). guard threaded through module-level _process_listing_url/_emit_detail helpers.",
    },
    "Ni9pNhSXGT4Ul8vQL": {
        "github_repo": "johnisanerd/ApifyRealestateAU",
        "local_path": "~/Github/ApifyRealestateAU/ApifyRealestateAU",
        "installed_utc": "2026-09-08",
        "charge_event": "listing-scraped",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Shape A, two identical sites (search + url modes), main-wrapper.",
    },
    "Q9ze1MsPv2DC2N9pj": {
        "github_repo": "johnisanerd/ApifyTripadvisor",
        "local_path": "~/Github/ApifyTripadvisor/ApifyTripadvisor",
        "installed_utc": "2026-09-08",
        "charge_event": "place_returned",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Shape A, mode-based event (place_returned/review_returned), main-wrapper.",
    },
    "Tb1DVc1tVAN5m23bp": {
        "github_repo": "johnisanerd/ApifyTrustRadiusReviews",
        "local_path": "~/Github/ApifyTrustRadiusReviews/ApifyTrustRadiusReviews",
        "installed_utc": "2026-09-08",
        "charge_event": "review-scraped",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Shape A, two identical sites (review + product modes), main-wrapper.",
    },
    "slTBbdmqZE3grzb3L": {
        "github_repo": "johnisanerd/ApifyVentureRadar",
        "local_path": "~/Github/ApifyVentureRadar/ApifyVentureRadar",
        "installed_utc": "2026-09-08",
        "charge_event": "company-scraped",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "uv.lock",
    ...
    "auibiWMjY5H9EdInk": {
        "github_repo": "johnisanerd/ApifyWalmart",
        "local_path": "~/Github/ApifyWalmart/ApifyWalmart",
        "installed_utc": "2026-09-08",
        "charge_event": "product_returned",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Shape A, mode-based event (product/detail/reviews/sellers), main-wrapper.",
    },
    "aRuPsw2Q3N9uyapLB": {
        "github_repo": "johnisanerd/ApifyXingProfiles",
        "local_path": "~/Github/ApifyXingProfiles/ApifyXingProfiles",
        "installed_utc": "2026-09-08",
    ...
    "dNfYhaMvn8GJgQ7gG": {
        "github_repo": "johnisanerd/ApifyBingCopilot",
        "local_path": "~/Github/ApifyBingCopilot/ApifyBingCopilot",
        "installed_utc": "2026-09-08",
        "charge_event": "copilot_queried",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Shape A _charge->bool routed through guard.charge (fetch-failure + success sites). Inline single-main with budget pre-check.",
    },
    "YxDojfBVnybYfY5Nc": {
        "github_repo": "johnisanerd/ApifyGlassdoorReviews",
        "local_path": "~/Github/ApifyGlassdoorReviews/ApifyGlassdoorReviews",
        "installed_utc": "2026-09-08",
        "charge_event": "review-scraped",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Shape A _charge->bool. Chunked collect loop (companies); try/finally added around the loop.",
    },
    "uEwfN1pgO878LIKts": {
        "github_repo": "johnisanerd/ApifyMapsPlaceContacts",
        "local_path": "~/Github/ApifyMapsPlaceContacts/ApifyMapsPlaceContacts",
        "installed_utc": "2026-09-08",
        "charge_event": "place_enriched",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Shape A, TWO events (place_enriched + contact_enrichment). SDK 4 (apify>=4). guard.close added to existing try/finally.",
    },
    "QwAkysoIIBCPz3yc8": {
        "github_repo": "johnisanerd/ApifyAgodaHotels",
        "local_path": "~/Github/ApifyAgodaHotels/ApifyAgodaHotels",
        "installed_utc": "2026-09-08",
        "charge_event": "property-scraped",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Shape A, events property-scraped + review-scraped via nested _push_and_charge helper. Main-wrapper: guard in main(), passed to _run(guard).",
    },
    "m2EB9prGrPaRNS0uS": {
        "github_repo": "johnisanerd/ApifyGooglePlay",
        "local_path": "~/Github/ApifyGooglePlay/ApifyGooglePlay",
        "installed_utc": "2026-09-08",
        "charge_event": "app_returned",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Shape A, mode-based event (app_returned/app_detail_returned/review_returned). Main-wrapper pattern.",
    },
    "ftKm2bcovx3Np2xmY": {
        "github_repo": "johnisanerd/ApifyGoogleForums",
        "local_path": "~/Github/ApifyGoogleForums/ApifyGoogleForums",
        "installed_utc": "2026-09-08",
        "charge_event": "page_processed",
        "charge_granularity": "per page",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Shape A, setup + page_processed events. SDK 4. Main-wrapper pattern.",
    },
    "ajnnira9n6X6qo9Dw": {
        "github_repo": "johnisanerd/ApifyImageSimilarity",
        "local_path": "~/Github/ApifyImageSimilarity/ApifyImageSimilarity",
        "installed_utc": "2026-09-08",
        "charge_event": "comparison",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Shape A, single event. Main-wrapper; guard.exhausted checked before the existing limit_hit/summary branches.",
    },
    "mYvnxgsWO1phJxnWW": {
        "github_repo": "johnisanerd/ApifyMartindaleLawyers",
        "local_path": "~/Github/ApifyMartindaleLawyers/ApifyMartindaleLawyers",
        "installed_utc": "2026-09-08",
        "charge_event": "lawyer-scraped",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Shape A, two identical charge sites. Main-wrapper. Push needed http.version HTTP/1.1 (HTTP/2 sideband disconnect).",
    },
    "k5h0EdiDWxQyETx6f": {
        "github_repo": "johnisanerd/ApifyN8nTemplates",
        "local_path": "~/Github/ApifyN8nTemplates/ApifyN8nTemplates",
        "installed_utc": "2026-09-08",
        "charge_event": "template_returned",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Shape A, template_returned + workflow_json_returned. Charging centralized in _RunState.push_template; guard threaded through _RunState(guard).",
    },
    "2a416mLXkRVcLH3gA": {
        "github_repo": "johnisanerd/ApifyIcimsScraper",
        "local_path": "~/Github/ApifyIcimsScraper/ApifyIcimsScraper",
        "installed_utc": "2026-09-08",
        "charge_event": "job-result",
        "charge_granularity": "per item",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Shape A, actor-start fee + job-result/job-result-proxy. guard threaded through module-level _collect_source/_push_portal_details helpers (keyword-only param).",
    },
    "u2azjcqJVle8Jbjyy": {
    ...
    "SVdYzqKOwfJT7shHd": {
        "github_repo": "johnisanerd/ApifyStartupInvestors",
        "local_path": "~/Github/ApifyStartupInvestors/ApifyStartupInvestors",
        "installed_utc": "2026-09-07",
        "charge_event": "setup + firms_retrieved + contacts_retrieved",
        "charge_granularity": "per firm (+ contacts)",
        "dockerfile_installs_from": "requirements.txt",
        "notes": "No _charge helper - inline Actor.charge in a nested firms loop. Keeps its own charges, meters with guard.record() at setup + after each firm's charge, breaks the loop when exhausted. guard.blocked before the setup fee. SDK 2.7.3. requirements.txt only (no pyproject) - tarball hand-added; httpx chain already present. Free-path metered $0.17 (firms_retrieved is pricey - ~6 runs to a $1 cap).",
    },
    "ZtBuxIbU7gPdQozq3": {
        "github_repo": "johnisanerd/ApifyMapsContributorReviews",
        "local_path": "~/Github/ApifyMapsContributorReviews/ApifyMapsContributorReviews",
        "installed_utc": "2026-09-07",
        "charge_event": "actor_start + review_scraped",
        "charge_granularity": "per review",
        "dockerfile_installs_from": "requirements.txt",
        "notes": "Single _charge helper; guard routed via module handle, started before the client. Dockerfile pip-installs requirements.txt -> regenerated via uv export (google-images trap). SDK 3.3, v0.1.8. Free-path metered $0.0069.",
    },
    "6KLyRx66f0nHYV60f": {
        "github_repo": "johnisanerd/Apify-GooglePatents",
        "local_path": "~/Github/Apify-GooglePatents/ApifyGooglePatents",
        "installed_utc": "2026-09-07",
        "charge_event": "setup + page_processed",
        "charge_granularity": "per page",
        "dockerfile_installs_from": "uv.lock",
        "notes": "TWO charge helpers (_charge_setup, _charge_page) that return True=SUCCESS (inverted from the usual True=stop). Meter with guard.record() inside each; on exhaustion _charge_page returns False, reusing the caller's existing `if not await _charge_page(): return` stop path. SDK 2.7.3. Free-path metered $0.039.",
    },
    "S4vytlD3hbgocTHi6": {
        "github_repo": "johnisanerd/ApifyGoogleLocalServices",
        "local_path": "~/Github/ApifyGoogleLocalServices/ApifyGoogleLocalServices",
        "installed_utc": "2026-09-07",
        "charge_event": "location_resolved + business_returned",
        "charge_granularity": "per business",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Single _charge helper (2 sites); guard routed via module handle, started before the client, status skipped when exhausted. SDK 3.4, v0.1.8. Free-path metered $0.0306. SERPAI_KEY, $0.004/business = real cash.",
    },
    "KXtydhfbdBPC0hU7R": {
        "github_repo": "johnisanerd/ApifyGoogleLens",
        "local_path": "~/Github/ApifyGoogleLens/ApifyGoogleLens",
        "installed_utc": "2026-09-07",
        "charge_event": "visual/product/exact_match_returned",
        "charge_granularity": "per match row",
        "dockerfile_installs_from": "uv.lock",
        "notes": "_run() worker + main try/finally; single _charge routed via module handle, guard started before the client, closed in main's finally. SDK 3.4, v0.1.8. Free-path metered $0.001 (4 matches).",
    },
    "czXNneHcGQ1vsxmwu": {
        "github_repo": "johnisanerd/ApifyGoogleMapsDirections",
        "local_path": "~/Github/ApifyGoogleMapsDirections/ApifyGoogleMapsDirections",
        "installed_utc": "2026-09-07",
        "charge_event": "setup + directions_processed",
        "charge_granularity": "per lookup (single origin->destination per run)",
        "dockerfile_installs_from": "requirements.txt",
        "notes": "_charge returned None and callers never stopped (single lookup, no loop). Routed through the guard via module handle to METER; the cap turns an over-allowance free user away at start(). Dockerfile pip-installs requirements.txt -> regenerated via uv export (google-images trap). SDK 3.3, v0.1.8. Free-path metered $0.0248.",
    },
    "itMT9aXhvbNwasFYH": {
        "github_repo": "johnisanerd/ApifyGoogleNews",
        "local_path": "~/Github/ApifyGoogleNews/ApifyGoogleNews",
        "installed_utc": "2026-09-07",
        "charge_event": "setup + page_processed",
        "charge_granularity": "per page",
        "dockerfile_installs_from": "uv.lock",
        "notes": "news-lite shape, SDK 2.7.3. No _charge helper - keeps its own Actor.charge (verifies charged_count) and meters with guard.record() at setup + each page, breaking the page loop when exhausted. guard.blocked before the funds check. v0.1.8. Free-path metered $0.0299.",
    },
    "9Yy2qkVB4G49ayWXq": {
        "github_repo": "johnisanerd/ApifyWorkdayScraper",
        "local_path": "~/Github/ApifyWorkdayScraper/ApifyWorkdayScraper",
        "installed_utc": "2026-09-07",
        "charge_event": "actor-start + job-result",
        "charge_granularity": "per job",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Single _charge helper (actor-start + per-job); guard routed via module handle, started before the actor-start charge, closed after the final status. SDK 3.4, v0.1.8. Free-path metered $0.00135.",
    },
    "YI3eVZdrh15SoADFT": {
        "github_repo": "johnisanerd/ApifyTrustpilotReviews",
        "local_path": "~/Github/ApifyTrustpilotReviews/ApifyTrustpilotReviews",
        "installed_utc": "2026-09-07",
        "charge_event": "review-scraped",
        "charge_granularity": "per review",
        "dockerfile_installs_from": "uv.lock",
        "notes": "_run() worker + main try/finally; single _charge routed via module handle, guard started before the client, closed in main's finally. SDK 3.4, v0.1.8. Free-path metered $0.0114 (4 reviews).",
    },
    "J0ulz8eoVqej6oqIf": {
        "github_repo": "johnisanerd/ApifyGoogleJobsPayPerResult",
        "local_path": "~/Github/ApifyGoogleJobsPayPerResult/ApifyGoogleJobs",
        "installed_utc": "2026-09-07",
        "charge_event": "apify-default-dataset-item (platform per-row)",
        "charge_granularity": "per pushed row",
        "dockerfile_installs_from": "requirements.txt",
        "notes": "FIRST meter-on-push install: PPR actor with NO Actor.charge seam (bills purely via the platform apify-default-dataset-item at $0.015/row). Guard meters that event with guard.record() after each push and breaks the loop when exhausted; guard.blocked turns a free user away before the SerpApi call. No pyproject/uv.lock - the tarball + httpx chain are hand-pinned in requirements.txt (crawlee 1.8.2 uses impit, not httpx). SDK 3.4, v0.1.8. Free-path metered $0.14/10 rows.",
    },
    "O63j3hLJAHrHI1P00": {
        "github_repo": "johnisanerd/ApifyOpenTableReviews",
        "local_path": "~/Github/ApifyOpenTableReviews/ApifyOpenTableReviews",
        "installed_utc": "2026-09-04",
        "charge_event": "review_scraped + restaurant_metadata_pulled",
        "charge_granularity": "per review",
        "dockerfile_installs_from": "uv.lock",
        "notes": "Single _charge helper feeding concurrent process_restaurant() under a charge_lock; guard routed through _charge via a module handle, started before the client. Free-path metered $0.03168 (4 reviews). SDK 3.3, v0.1.8. SERPAI_KEY backend.",
    },
    "JYnIiqxn4hMnWZiKQ": {
        "github_repo": "johnisanerd/ApifyClutch",
        "local_path": "~/Github/ApifyClutch/ApifyClutch",
        "installed_utc": "2026-09-04",
        "charge_event": "listing-scraped + profile-scraped + review-scraped",
        "charge_granularity": "per row",
        "dockerfile_installs_from": "uv.lock",
        "notes": "_run() worker called from main()'s try/finally; guard routed through _charge (3 sites), started in _run before the fetcher, closed in main's finally. Free-path metered $0.0025 (1 profile). SDK 3.4, v0.1.8.",
    },
    "qTS4FTyj3jfN1ebB1": {
        "github_repo": "johnisanerd/ApifyG2Reviews",
        "local_path": "~/Github/ApifyG2Reviews/ApifyG2Reviews",
        "installed_utc": "2026-09-04",
        "charge_event": "review-scraped + product-metadata",
        "charge_granularity": "per review",
        "dockerfile_installs_from": "uv.lock",
        "notes": "WRINKLE: _charge returns bool|None and callers use `is not None` (charged) / `is True` (stop); routing through the guard returns a bool on-platform, keeping both checks correct. Guard verified live (disclosure + prices read) but no free-path ledger row captured on install because the G2 upstream data API was returning 0 reviews / HTTP 400 metadata for the test products (data-source issue, not the cap). SDK 3.4, v0.1.8.",
    },
    "P9ArUDJDSgHTmYzDp": {
